...
// });
  ...
  console.log("aa",this.orbit.maxPolarAngle )  
  this.orbit.update()
    this.Init();
...
window.addEventListener('resize', this.onWindowResize, false);
  ...
  async hdrBackground(){
    ...
    // const envMap = await hdrLoader.loadAsync( 'assets/ff2.hdr' );
    const envMap = await hdrLoader.loadAsync( 'assets/hdr/kloppenheim_07_puresky_4k.hdr' );

    envMap.mapping = THREE.EquirectangularReflectionMapping;
  
    let skybox = new GroundedSkybox( envMap, params.height, params.radius );
    skybox.position.y = params.height - 0.5;
 ...
 outerHandleColorButtonClick(colorName) {
  ...
  loadOBJModel() {
    ...
    objLoader.load('chosen/Baseball1/baseball_glove.obj', (obj) => {
      ...
      this.windowModel.position.set(0, 10, 0);
  ...
  // })
    ...
    glbLoader.load('assets/chair.gltf', (gltf) => {
      ...
      this.windowModel.position.set(0, -0.43, 0);
      // this.windowModel.rotation.set(0, 0, 0);
